...
public class ExceptionHandler {
  ...
  /**
   * 處理 Redis 相關異常並記錄日誌
   * @param operation 描述操作的字串（如 "caching company data"）
   * @param symbol 相關符號（如股票代碼）
   * @param e 異常對象
   */
  public static void handleRedisException(String operation, String symbol, RedisConnectionFailureException e) {
      logger.error("Redis connection failed {} for symbol: {}", operation, symbol, e);
  }
